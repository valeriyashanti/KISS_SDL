...
void button_event_connect(kiss_button *button, SDL_Event *e, int *draw, 
	char *ip)
{
	if (kiss_button_event(button, e, draw))
	{
...
void button_event_gpu(kiss_button *button, SDL_Event *e,
	int *draw, int *gpu)
{
	if (kiss_button_event(button, e, draw))
	{
...
void button_event_open_f(kiss_button *button, SDL_Event *e,
	int *draw, int *mode, int *open)
{
	if (kiss_button_event(button, e, draw))
	{
...
void button_event_cpu(kiss_button *button, SDL_Event *e,
	int *draw, int *cpu)
{
	if (kiss_button_event(button, e, draw))
	{
...
void button_event_network(kiss_button *button, SDL_Event *e,
	int *draw, int *network)
{
	if (kiss_button_event(button, e, draw))
	{
